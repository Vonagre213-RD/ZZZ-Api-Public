...
const getRows = async (name?: string | null, faction?: string | null, attributeName?: string | null, agentId?: string | null) => {
...
/* ===========================
    ...
    router.get('/characters/agents/All', async (req: Request, res: Response) => {
        const rows = await getRows()

        res.status(200).json(rows)
    })
    //base Searchs
    router.get('/characters/agents/name/:name', async (req: Request, res: Response) => {
    ...
    router.get('/characters/agents/Attribute/:attributeName', async (req: Request, res: Response) => {
    ...
    router.get('/characters/agents/faction/:factionName', async (req: Request, res: Response) => {
    ...
    router.get('/characters/agents/id/:agentId', async (req: Request, res: Response) => {
